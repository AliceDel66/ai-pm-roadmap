...
<img src="./src/assets/logo.png" alt="Coriander logo" width="120" />
...
![Website](https://img.shields.io/badge/Website-agentskill.asia-06B6D4)
...
动画系统基于开源免费依赖 `@xyflow/react` 和 `motion` 实现，动画数据全部在项目本地维护，不依赖外部服务、远程脚本、版权图片或真实品牌素材。社区贡献者可以按照 [docs/animation-system.md](./docs/animation-system.md) 新增流程动画、步骤动画或概念对比动画。
