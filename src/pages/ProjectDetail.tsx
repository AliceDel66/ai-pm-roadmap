...
import { getProjectDoc } from "../content-loader/projectLoader";
...
export function ProjectDetail() {
  ...
  return (
    <main className="container-page pt-24">
      ...
      {projectContent ? (
        <article className="panel my-8 rounded-2xl p-6 lg:p-8">
